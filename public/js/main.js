$(function() {
    ...
    $(".menu-content").each(function() {
        ...
        if ($lis.length > 0) {
            $ul.append(
                $(
                    '<li class="expand">' +
                    (isExpanded ? '<a href="javascript:;"><span><i class="ion-android-remove"></i>Cerrar Categorías</span></a>' : '<a href="javascript:;"><span><i class="ion-android-add"></i>Mas Categorías</span></a>') +
                    "</li>"
                ).on("click", function(event) {
                    var isExpanded = $ul.hasClass("expanded");
                    event.preventDefault();
                    $(this).html(isExpanded ? '<a href="javascript:;"><span><i class="ion-android-add"></i>Mas Categorías</span></a>' : '<a href="javascript:;"><span><i class="ion-android-remove"></i>Cerrar Categorías</span></a>');
    ...
    $("#more-btn").on("click", function(e) {
        ...
        var htmlAfter = '<i class="ion-ios-minus-empty" aria-hidden="true"></i> Menos Categorías';
        var htmlBefore = '<i class="ion-ios-plus-empty" aria-hidden="true"></i> Mas Categorías';
