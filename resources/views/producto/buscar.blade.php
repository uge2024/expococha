    ...
    <div class="shop-category-area mt-30px">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <!-- Shop Top Area Start -->
                    <form action="{{url('producto/buscar')}}" id="formOrdenar" method="get">
                        <div class="shop-top-bar d-flex">
                            ...
                            <div class="select-shoing-wrap d-flex">
                                ...
                                <div class="shop-select">
                                    {{
                                        Form::select('sort',[1=>'Nombre de Productos (A a Z)',2=>'Precio'],$sort,  ['onchange' => 'this.form.submit();','id' => 'sort'])
                                    }}
                                </div>
                            </div>
                            <!-- Right Side End -->
                    ...
                    <div class="shop-bottom-area mt-35">
                        ...
                        <div class="d-flex justify-content-center">
                            {{ $productos->appends(['sort'=>$sort,'search'=>$search,'cat_id'=>$cat_id])->links() }}
                        </div>
                        <!--  Pagination Area End -->
                    </div>
...
@section('footer_scripts')
    ...
    <script>
        ...
        $(document).ready(function(){
            $("#search_web").val(search);
            $("#search_movil").val(search);
            $("#cat_id_web").val(cat_id);
            $("#cat_id_movil").val(cat_id);
        });
    </script>
@stop
