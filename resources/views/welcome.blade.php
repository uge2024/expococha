...
<div class="slider-area slider-dots-style-3">
    <div class="hero-slider-wrapper">
        <!-- Single Slider  -->
        <div class="single-slide slider-height-3 bg-img d-flex" data-bg-image="images/slider-image/sample-7.jpg">
        ...
        <!-- Single Slider  -->
        <div class="single-slide slider-height-3 bg-img d-flex" data-bg-image="images/slider-image/sample-8.jpg">
            <div class="container align-self-center">
        ...
        <!-- Single Slider  -->
        <div class="single-slide slider-height-3 bg-img d-flex" data-bg-image="images/slider-image/sample-9.jpg">
            <div class="container align-self-center">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="banner-wrapper">
                    <a href="shop-4-column.html"><img src="images/banner-image/11.jpg" alt="" /></a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="banner-wrapper">
                    <a href="shop-4-column.html"><img src="images/banner-image/12.jpg" alt="" /></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <ul class="nav nav-tabs sub-category">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tab-1">Home Audio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tab-2">Headphones</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tab-3">Cameras</a>
                        </li>
                    </ul>
                    <!-- Nav tabs -->
                </div>
                    ...
                    <div class="slider-single-item">
                            ...
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/4.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/5.jpg" alt="" />
                                    </a>
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/6.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/7.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                    ...
                    <div class="slider-single-item">
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/8.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/9.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/10.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/11.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                    ...
                    <div class="slider-single-item">
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/12.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/13.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/14.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/15.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                    ...
                    <div class="slider-single-item">
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/16.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/17.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/18.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/19.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                    ...
                    <div class="slider-single-item">
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/20.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/21.jpg" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
    ...
    <div class="container">
        ...
        <div class="popular-category-slider-wrapper slider-nav-style-2">
            ...
            <div class="single-slider-item">
                <div class="thumb-category">
                    <a href="single-product.html">
                        <img src="images/popular-image/2-1.jpg" alt="product-image.jpg" />
                    </a>
                </div>
            ...
            <div class="single-slider-item">
                <div class="thumb-category">
                    <a href="single-product.html">
                        <img src="images/popular-image/2-2.jpg" alt="product-image.jpg" />
                    </a>
                </div>
                <div class="category-discript">
                    <h4>Home Audio</h4>
            ...
            <div class="single-slider-item">
                <div class="thumb-category">
                    <a href="single-product.html">
                        <img src="images/popular-image/2-3.jpg" alt="product-image.jpg" />
                    </a>
                </div>
                <div class="category-discript">
                    <h4>Audio & Video</h4>
            ...
            <div class="single-slider-item">
                <div class="thumb-category">
                    <a href="single-product.html">
                        <img src="images/popular-image/2-4.jpg" alt="product-image.jpg" />
                    </a>
                </div>
                <div class="category-discript">
                    <h4>Cameras</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6 mb-md-30px mb-lm-30px">
                    <div class="single-static">
                        <img src="images/icons/static-icons-1.png" alt="" class="img-responsive" />
                ...
                <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6 mb-md-30px mb-lm-30px">
                    <div class="single-static">
                        <img src="images/icons/static-icons-2.png" alt="" class="img-responsive" />
                        <div class="single-static-meta">
                            <h4>Free Returns</h4>
                ...
                <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6 mb-sm-30px">
                    <div class="single-static">
                        <img src="images/icons/static-icons-3.png" alt="" class="img-responsive" />
                        <div class="single-static-meta">
                ...
                <div class="col-lg-3 col-xs-12 col-md-6 col-sm-6">
                    <div class="single-static">
                        <img src="images/icons/static-icons-4.png" alt="" class="img-responsive" />
                        <div class="single-static-meta">
                            <h4>Support 24/7</h4>
            ...
            <div class="single-slider-item">
                ...
                <article class="list-product text-center">
                    <div class="product-inner">
                        <div class="img-block">
                            <a href="single-product.html" class="thumbnail">
                                <img class="first-img" src="images/product-image/15.jpg" alt="" />
                                <img class="second-img" src="images/product-image/16.jpg" alt="" />
                            </a>
                            <div class="add-to-link">
                                <ul>
                                    <li>
                    ...
                    <div class="slider-single-item">
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/19.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/20.jpg" alt="" />
                                    </a>
                                </div>
                                <div class="product-decs">
                                    <h2><a href="single-product.html" class="product-link">Silicon Sleeping Earbuds</a></h2>
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/13.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/14.jpg" alt="" />
                                    </a>
                                </div>
                                <div class="product-decs">
                                    <h2><a href="single-product.html" class="product-link">Numkuda USB 2.0 Gamepad</a></h2>
                        ...
                        <article class="list-product text-center">
                            <div class="product-inner">
                                <div class="img-block">
                                    <a href="single-product.html" class="thumbnail">
                                        <img class="first-img" src="images/product-image/11.jpg" alt="" />
                                        <img class="second-img" src="images/product-image/12.jpg" alt="" />
                                    </a>
                                </div>
                                <div class="product-decs">
                                    <h2><a href="single-product.html" class="product-link">Edifier H840 Audiophile</a></h2>
